 ...
 */
public class JestRowne extends Porownanie{
    /**
     * Domyślny konstruktor dla klasy "JestRowne" - tworzy obiekt reprezentujący
     * porównanie "=="  z dwoma argumentami
     * @param argument1 : wyraz pierwszy
     * @param argument2 : wyraz drugi
     */
    public JestRowne(Wyrazenie argument1, Wyrazenie argument2) {
        super(argument1, argument2);
    }

    /**
     * @return symbol reprezentujący operację "=="
     */
    @Override
